...
public:
	...
	int getAuthorCount() const;		// PRECONDITION:  None.
									// POSTCONDITION: Returns number of authors
									//				  for book as an integer
	...
	// DESTRUCTOR
	~bookType();                    // DESTRUCTOR TO DELETE DYNAMICALLY ALLOCATED
